...
/*
File Name:                      SimpleJVSScript4.java
...
public class SimpleJVSScript4 extends AbstractGenericScript {
     ...
     */
    public SimpleJVSScript4() throws OException {
        super();
    ...
    public void execute(Table argt, Table returnt) throws OException {
		...
		OConsole.oprint("iam here");
		Oconsole.oprint("Nice to have you here");
